...
public class MainTripletoQuestions_EN implements ConstantsQuestion {
    ...
    public static void main(String[] args) {
        ...
        List<String> dpediaPropertyFiles = Stream.of(mappingbased_objects, specific_mappingbased_properties, mappingbased_literals, persondata, mappingbased_objects_disjoint_domain, mappingbased_objects_disjoint_range, infobox_properties).collect(Collectors.toCollection(ArrayList::new));
        ...
        for (String language : languages) {
            ...
            String propertyDir = languageDir + File.separator + "propertyT" + File.separator;

            if (menus.contains(FIND_PROPERTY)) {
                String content = "";
                Map<String, String> allProperties = new TreeMap<String, String>();
                for (String fileName : dpediaPropertyFiles) {
